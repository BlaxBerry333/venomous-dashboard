...
export const USER_BASE_SCHEMA = z.object({
  ...
  email: z
    .email(VALIDATION_MESSAGE_I18N_KEYS.EMAIL_INVALID)
    .max(100, VALIDATION_MESSAGE_I18N_KEYS.EMAIL_TOO_LONG)
...
export const USER_UPDATE_PROFILE_SCHEMA = z
  .object({
    avatarPath: z.string().optional(),
  })
  .extend(USER_BASE_SCHEMA.shape);
